        ...
        <div class="card-body">
            ...
            <form action="scripts/register.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="contact" name="email" type="text" class="form-control" placeholder="Enter Proper Email" maxlength="20" required>
                ...
                <div class="form-group">
                    ...
                    <input id="adder1" name="adder1" type="text" class="form-control" placeholder="Enter House number , Society name , Locality , Area"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input id="adder2" name="adder2" type="text" class="form-control" placeholder="Enter City , State , Pin code , Country "
                        required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="profession" id="profession" required>
                        ...
                        <option value="mobile" name="profession">Carpenter</option></select>
                </div>
